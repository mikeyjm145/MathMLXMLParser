module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c23 = function(expr) { return toMathParenthesis("(", expr, ")"); },
        peg$c24 = "[",
        peg$c25 = { type: "literal", value: "[", description: "\"[\"" },
        peg$c26 = "]",
        peg$c27 = { type: "literal", value: "]", description: "\"]\"" },
        peg$c28 = function(expr) { return toMathParenthesis("[", expr, "]"); },
        peg$c29 = "|",
        peg$c30 = { type: "literal", value: "|", description: "\"|\"" },
        peg$c31 = function(expr) { return toMathParenthesis("|", expr, "|"); },
        peg$c32 = "{",
        peg$c33 = { type: "literal", value: "{", description: "\"{\"" },
        peg$c34 = "}",
        peg$c35 = { type: "literal", value: "}", description: "\"}\"" },
        peg$c36 = function(expr) { return toMathParenthesis("", expr, ""); },
        peg$c37 = "#{",
    ...
    function peg$parse_() {
      ...
      function toMathMLPostscript(postbase, postsuper) {
        return "<msup>\n" + postbase + toMathMLNumber("\n" + postsuper) + "</msup>\n";
      }

      function toMathMLPrescript(presub, presuper) {
        return "<msub>\n" + presub + toMathMLNumber("\n" + presuper) + "</msub>\n";
      }
      ...
      function toMathParenthesis(symbolBegin, value, symbolEnd) {
        return "<mfenced open='"+ symbolBegin +"' close='" + symbolEnd + "'>\n" + value + "</mfenced>\n";
      }
