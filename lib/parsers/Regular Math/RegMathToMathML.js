var parserForRegMath = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c23 = function(expr) { return "<mfenced open='(' close=')' separators=''>\n" + expr + "</mfenced>\n"; },
        peg$c24 = "[",
        peg$c25 = { type: "literal", value: "[", description: "\"[\"" },
        peg$c26 = "]",
        peg$c27 = { type: "literal", value: "]", description: "\"]\"" },
        peg$c28 = function(expr) { return "<mfenced open='[' close=']' separators=''>\n" + expr + "</mfenced>\n"; },
        peg$c29 = "|",
        peg$c30 = { type: "literal", value: "|", description: "\"|\"" },
        peg$c31 = function(expr) { return "<mfenced open='|' close='|' separators=''>\n" + expr + "</mfenced>\n"; },
        peg$c32 = "{",
        peg$c33 = { type: "literal", value: "{", description: "\"{\"" },
        peg$c34 = "}",
        peg$c35 = { type: "literal", value: "}", description: "\"}\"" },
        peg$c36 = function(expr) { return "<mfenced open='' close='' separators=''>\n" + expr + "</mfenced>\n"; },
        peg$c37 = { type: "other", description: "integer" },
        peg$c38 = /^[0-9]/,
        peg$c39 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c40 = function() { return toMathMLNumber(text()); },
        peg$c41 = { type: "other", description: "identifier" },
        peg$c42 = /^[a-zA-Z]/,
        peg$c43 = { type: "class", value: "[a-zA-Z]", description: "[a-zA-Z]" },
        peg$c44 = function() { return toMathMLIdentifier(text()); },
        peg$c45 = { type: "other", description: "identeger" },
        peg$c46 = /^[a-zA-z]/,
        peg$c47 = { type: "class", value: "[a-zA-z]", description: "[a-zA-z]" },
        peg$c48 = function() {return toMathMLNumber(text());},
        peg$c49 = { type: "other", description: "Prescript" },
        peg$c50 = /^[_]/,
